...
Let's explore an example of recognizing and creating our own R chunks in our **first_rmarkdown.Rmd** file:

```{r rchunks, echo=FALSE, fig.cap="Creating and identifying R chunks"}
knitr::include_graphics("gifs/rchunks.gif")
```
...
knitr::include_graphics("gifs/inliner.gif")
```
...
knitr::include_graphics("gifs/inliner2.gif")
```
...
knitr::include_graphics("gifs/chunkops.gif")
```
...
knitr::include_graphics("gifs/chunkops2.gif")
```
...
knitr::include_graphics("screenshots/cheatsheets.png")
```
